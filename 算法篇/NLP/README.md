...
- 单句分类任务
  ...
  输入端同GPT一样，对句子增加起始和终结符号，输入部分，和句子关系 类任务一致。
...
#### 5.5.3 **Permutation Language Modeling**
...
#### 5.5.4  Incorporating Ideas from Transformer-X



#### 5.5.5 Modeling Multiple Segments



#### 5.5.6 Comparison with BERT
